...
export function getSmtpConfig(): SmtpConfig | null {
  ...
  const from = process.env.SMTP_FROM || process.env.EMAIL_FROM || (user || 'noreply@titanforgegym.com');
  const fromName = process.env.SMTP_FROM_NAME || 'TitanForge Fitness & Gym';
